                    ...
                    {[
                      {
                        ...
                        value: licenseData.starts_at
                          ? new Intl.DateTimeFormat(undefined, { day: "numeric", month: "short", year: "numeric" }).format(new Date(licenseData.starts_at))
                          : "—",
                      ...
                      },
                      {
                        ...
                        value: licenseData.ends_at
                          ? new Intl.DateTimeFormat(undefined, { day: "numeric", month: "short", year: "numeric" }).format(new Date(licenseData.ends_at))
                          : "—",
                        icon: <Calendar className="h-4 w-4" />,
                      },
                      {
