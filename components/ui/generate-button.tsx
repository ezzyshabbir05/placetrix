...
export interface GenerateButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
  ...
  /**
   * Text to display in normal state. Default is "Generate"
   */
  text?: string;
  /**
   * Text to display in generating state. Default is "Generating"
   */
...
export function GenerateButton({
  ...
  const maxLen = Math.max(text.length, generatingText.length);
  // Estimate character width at ~0.55em to set a safe minimum width and prevent clipping or layout shifting
  const dynamicMinWidth = `${maxLen * 0.55}em`;
  ...
  return (
    <div className="relative inline-block group">
      <style>{`
        ...
        .gen-btn-letter:nth-child(14), .gen-btn[data-generating="true"] .gen-btn-letter:nth-child(14) { animation-delay: 1.04s; }
        .gen-btn-letter:nth-child(15), .gen-btn[data-generating="true"] .gen-btn-letter:nth-child(15) { animation-delay: 1.12s; }
        .gen-btn-letter:nth-child(16), .gen-btn[data-generating="true"] .gen-btn-letter:nth-child(16) { animation-delay: 1.2s; }
        .gen-btn-letter:nth-child(17), .gen-btn[data-generating="true"] .gen-btn-letter:nth-child(17) { animation-delay: 1.28s; }
        .gen-btn-letter:nth-child(18), .gen-btn[data-generating="true"] .gen-btn-letter:nth-child(18) { animation-delay: 1.36s; }
        .gen-btn-letter:nth-child(19), .gen-btn[data-generating="true"] .gen-btn-letter:nth-child(19) { animation-delay: 1.44s; }
        .gen-btn-letter:nth-child(20), .gen-btn[data-generating="true"] .gen-btn-letter:nth-child(20) { animation-delay: 1.52s; }
        .gen-btn-letter:nth-child(21), .gen-btn[data-generating="true"] .gen-btn-letter:nth-child(21) { animation-delay: 1.6s; }
        .gen-btn-letter:nth-child(22), .gen-btn[data-generating="true"] .gen-btn-letter:nth-child(22) { animation-delay: 1.68s; }
        .gen-btn-letter:nth-child(23), .gen-btn[data-generating="true"] .gen-btn-letter:nth-child(23) { animation-delay: 1.76s; }
        .gen-btn-letter:nth-child(24), .gen-btn[data-generating="true"] .gen-btn-letter:nth-child(24) { animation-delay: 1.84s; }
        .gen-btn-letter:nth-child(25), .gen-btn[data-generating="true"] .gen-btn-letter:nth-child(25) { animation-delay: 1.92s; }
      ...
      >
        ...
        <div className="gen-txt-wrapper" style={{ minWidth: dynamicMinWidth }}>
